...
export default function Dashboard() {
  ...
  const calculateNextPTTest = () => {
    ...
    const sortedTests = [...ptTests].sort(
  ...
  return (
    <div className="p-4">
      ...
      <Card className="mb-6 dark:bg-slate-800 dark:border-slate-700">
        <CardContent className="p-4">
          <div className="flex justify-between items-center mb-4">
            <h3 className="font-medium text-right dark:text-white">
              خلاصه امروز
            </h3>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <StatusCard
              ...
              value={
                medications?.find((m) => m.name === "Warfarin")?.dosage ||
                "تنظیم نشده"
              }
              subtitle={
                medications?.find((m) => m.name === "Warfarin")
            ...
            <StatusCard
              ...
              subtitle={
                nextTestDate === "فردا"
                  ? `وقت آزمایشگاه: ${formatTime("10:30")}`
                  : ""
              }
              color="warning"
            />
      ...
      <Card className="mb-6 dark:bg-slate-800 dark:border-slate-700">
        <CardContent className="p-4">
          <div className="flex justify-between items-center mb-4">
            ...
            <Link
              href="/pt-tracker"
              className="text-sm text-primary dark:text-blue-300"
            >
              مشاهده جزئیات
            </Link>
          </div>
      ...
      <Card className="dark:bg-slate-800 dark:border-slate-700">
        <CardContent className="p-4">
          <h3 className="font-medium mb-4 text-right dark:text-white">
            داروهای امروز
          </h3>
